...
@Composable
fun BodyContent(modifier: Modifier = Modifier, plantNames: List<String>, navController: NavController, viewModel: HomeViewModel) {
...
@Composable
fun PlantList(modifier: Modifier, plantNames: List<String>, navController: NavController, viewModel: HomeViewModel) {
    LazyColumn(modifier = modifier.padding(16.dp)) {
        items(plantNames.size) { index ->
            PlantItem(plantNames[index]) {
                viewModel.onPlantSelected(navController, plantNames[index])
            }
        }
    }
}
...
@Composable
fun PlantItem(planta: String, onClick: () -> Unit) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
